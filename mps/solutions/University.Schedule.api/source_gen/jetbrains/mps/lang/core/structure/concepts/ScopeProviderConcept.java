...
public class ScopeProviderConcept extends AbstractConcept<ScopeProvider> {

  @NotNull
  @Override
  public ScopeProvider createInstance(@NotNull INode node) {
  ...
  public static final ScopeProviderConcept INSTANCE = new ScopeProviderConcept();
  private ScopeProviderConcept() {
    super(true, "jetbrains.mps.lang.core.structure.ScopeProvider", "ScopeProvider", "ceab5195-25ea-4f22-9b92-103b95ca8c0c/3734116213129792499");
  }
