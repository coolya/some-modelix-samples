...
import jetbrains.mps.lang.core.structure.ImplementationContainer;
...
public class ImplementationContainerConcept extends AbstractConcept<ImplementationContainer> {

  @NotNull
  @Override
  public ImplementationContainer createInstance(@NotNull INode node) {
  ...
  public static final ImplementationContainerConcept INSTANCE = new ImplementationContainerConcept();
  private ImplementationContainerConcept() {
    super(true, "jetbrains.mps.lang.core.structure.ImplementationContainer", "ImplementationContainer", "ceab5195-25ea-4f22-9b92-103b95ca8c0c/1319728274783151479");
  }
