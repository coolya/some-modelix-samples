...
public class AttributeConcept extends AbstractConcept<Attribute> {

  @NotNull
  @Override
  public Attribute createInstance(@NotNull INode node) {
  ...
  public static final AttributeConcept INSTANCE = new AttributeConcept();
  private AttributeConcept() {
    super(true, "jetbrains.mps.lang.core.structure.Attribute", "Attribute", "ceab5195-25ea-4f22-9b92-103b95ca8c0c/5169995583184591161");
  }
