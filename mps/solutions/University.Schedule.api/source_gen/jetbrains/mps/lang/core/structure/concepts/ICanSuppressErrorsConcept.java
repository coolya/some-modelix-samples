...
public class ICanSuppressErrorsConcept extends AbstractConcept<ICanSuppressErrors> {

  @NotNull
  @Override
  public ICanSuppressErrors createInstance(@NotNull INode node) {
  ...
  public static final ICanSuppressErrorsConcept INSTANCE = new ICanSuppressErrorsConcept();
  private ICanSuppressErrorsConcept() {
    super(true, "jetbrains.mps.lang.core.structure.ICanSuppressErrors", "ICanSuppressErrors", "ceab5195-25ea-4f22-9b92-103b95ca8c0c/3393165121846091586");
  }
