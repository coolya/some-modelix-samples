...
public class IDeprecatableConcept extends AbstractConcept<IDeprecatable> {

  @NotNull
  @Override
  public IDeprecatable createInstance(@NotNull INode node) {
  ...
  public static final IDeprecatableConcept INSTANCE = new IDeprecatableConcept();
  private IDeprecatableConcept() {
    super(true, "jetbrains.mps.lang.core.structure.IDeprecatable", "IDeprecatable", "ceab5195-25ea-4f22-9b92-103b95ca8c0c/1224608834445");
  }
