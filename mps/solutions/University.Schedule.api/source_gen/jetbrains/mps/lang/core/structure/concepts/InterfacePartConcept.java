...
import jetbrains.mps.lang.core.structure.InterfacePart;
...
public class InterfacePartConcept extends AbstractConcept<InterfacePart> {

  @NotNull
  @Override
  public InterfacePart createInstance(@NotNull INode node) {
  ...
  public static final InterfacePartConcept INSTANCE = new InterfacePartConcept();
  private InterfacePartConcept() {
    super(true, "jetbrains.mps.lang.core.structure.InterfacePart", "InterfacePart", "ceab5195-25ea-4f22-9b92-103b95ca8c0c/1319728274784973096");
  }
