...
import jetbrains.mps.lang.core.structure.ImplementationWithStubPart;
...
public class ImplementationWithStubPartConcept extends AbstractConcept<ImplementationWithStubPart> {

  @NotNull
  @Override
  public ImplementationWithStubPart createInstance(@NotNull INode node) {
  ...
  public static final ImplementationWithStubPartConcept INSTANCE = new ImplementationWithStubPartConcept();
  private ImplementationWithStubPartConcept() {
    super(true, "jetbrains.mps.lang.core.structure.ImplementationWithStubPart", "ImplementationWithStubPart", "ceab5195-25ea-4f22-9b92-103b95ca8c0c/6999738288738427190");
  }

  @Override
  protected void doInit() {
    this.superConcepts.add(ImplementationPartConcept.INSTANCE);
  }
  @NotNull
  @Override
