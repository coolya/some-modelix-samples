...
public class IMetaLevelChangerConcept extends AbstractConcept<IMetaLevelChanger> {

  @NotNull
  @Override
  public IMetaLevelChanger createInstance(@NotNull INode node) {
  ...
  public static final IMetaLevelChangerConcept INSTANCE = new IMetaLevelChangerConcept();
  private IMetaLevelChangerConcept() {
    super(true, "jetbrains.mps.lang.core.structure.IMetaLevelChanger", "IMetaLevelChanger", "ceab5195-25ea-4f22-9b92-103b95ca8c0c/201537367881071930");
  }
