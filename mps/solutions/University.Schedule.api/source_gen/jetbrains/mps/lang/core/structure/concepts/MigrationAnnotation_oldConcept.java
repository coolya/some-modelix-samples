...
import jetbrains.mps.lang.core.structure.MigrationAnnotation_old;
...
public class MigrationAnnotation_oldConcept extends AbstractConcept<MigrationAnnotation_old> {

  @NotNull
  @Override
  public MigrationAnnotation_old createInstance(@NotNull INode node) {
  ...
  public static final MigrationAnnotation_oldConcept INSTANCE = new MigrationAnnotation_oldConcept();
  private MigrationAnnotation_oldConcept() {
    super(true, "jetbrains.mps.lang.core.structure.MigrationAnnotation_old", "MigrationAnnotation_old", "ceab5195-25ea-4f22-9b92-103b95ca8c0c/2482611074347614920");
  }
