...
public class NodeAttributeConcept extends AbstractConcept<NodeAttribute> {

  @NotNull
  @Override
  public NodeAttribute createInstance(@NotNull INode node) {
  ...
  public static final NodeAttributeConcept INSTANCE = new NodeAttributeConcept();
  private NodeAttributeConcept() {
    super(false, "jetbrains.mps.lang.core.structure.NodeAttribute", "NodeAttribute", "ceab5195-25ea-4f22-9b92-103b95ca8c0c/3364660638048049748");
  }
