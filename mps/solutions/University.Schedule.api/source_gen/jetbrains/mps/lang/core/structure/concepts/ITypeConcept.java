...
public class ITypeConcept extends AbstractConcept<IType> {

  @NotNull
  @Override
  public IType createInstance(@NotNull INode node) {
  ...
  public static final ITypeConcept INSTANCE = new ITypeConcept();
  private ITypeConcept() {
    super(true, "jetbrains.mps.lang.core.structure.IType", "IType", "ceab5195-25ea-4f22-9b92-103b95ca8c0c/1234971358450");
  }
