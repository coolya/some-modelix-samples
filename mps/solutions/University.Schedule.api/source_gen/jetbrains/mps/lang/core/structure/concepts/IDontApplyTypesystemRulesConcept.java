...
import jetbrains.mps.lang.core.structure.IDontApplyTypesystemRules;
...
public class IDontApplyTypesystemRulesConcept extends AbstractConcept<IDontApplyTypesystemRules> {

  @NotNull
  @Override
  public IDontApplyTypesystemRules createInstance(@NotNull INode node) {
  ...
  public static final IDontApplyTypesystemRulesConcept INSTANCE = new IDontApplyTypesystemRulesConcept();
  private IDontApplyTypesystemRulesConcept() {
    super(true, "jetbrains.mps.lang.core.structure.IDontApplyTypesystemRules", "IDontApplyTypesystemRules", "ceab5195-25ea-4f22-9b92-103b95ca8c0c/2216760464199502422");
  }
