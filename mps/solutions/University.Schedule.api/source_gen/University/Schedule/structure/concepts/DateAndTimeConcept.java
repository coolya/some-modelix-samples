...
import University.Schedule.structure.DateAndTime;
...
public class DateAndTimeConcept extends AbstractConcept<DateAndTime> {

  @NotNull
  @Override
  public DateAndTime createInstance(@NotNull INode node) {
    return new DateAndTime(node);
  }
  ...
  public static final DateAndTimeConcept INSTANCE = new DateAndTimeConcept();
  private DateAndTimeConcept() {
    super(false, "University.Schedule.structure.DateAndTime", "DateAndTime", "96533389-8d4c-46f2-b150-8d89155f7fca/4128798754188010570");
  }

  @Override
  protected void doInit() {
    this.properties.put("date", new MPSProperty(this, "date"));
    this.properties.put("time", new MPSProperty(this, "time"));
