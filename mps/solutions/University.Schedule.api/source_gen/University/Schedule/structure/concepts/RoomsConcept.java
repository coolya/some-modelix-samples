...
public class RoomsConcept extends AbstractConcept<Rooms> {

  @NotNull
  @Override
  public Rooms createInstance(@NotNull INode node) {
    return new Rooms(node);
  }
  ...
  public static final RoomsConcept INSTANCE = new RoomsConcept();
  private RoomsConcept() {
    super(false, "University.Schedule.structure.Rooms", "Rooms", "96533389-8d4c-46f2-b150-8d89155f7fca/4128798754188010588");
  }

  @Override
  protected void doInit() {
    this.children.put("rooms", new MPSChildLink(this, RoomConcept.INSTANCE, true, true, "rooms"));
