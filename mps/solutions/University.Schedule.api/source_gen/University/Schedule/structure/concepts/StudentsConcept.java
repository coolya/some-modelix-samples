...
import University.Schedule.structure.Students;
...
public class StudentsConcept extends AbstractConcept<Students> {

  @NotNull
  @Override
  public Students createInstance(@NotNull INode node) {
    return new Students(node);
  }
  ...
  public static final StudentsConcept INSTANCE = new StudentsConcept();
  private StudentsConcept() {
    super(false, "University.Schedule.structure.Students", "Students", "96533389-8d4c-46f2-b150-8d89155f7fca/1648392019017048457");
  }

  @Override
  protected void doInit() {
    this.children.put("students", new MPSChildLink(this, StudentConcept.INSTANCE, true, true, "students"));
