...
import org.modelix.model.repositoryconcepts.structure.SingleLanguageDependency;
...
public class SingleLanguageDependencyConcept extends AbstractConcept<SingleLanguageDependency> {

  @NotNull
  @Override
  public SingleLanguageDependency createInstance(@NotNull INode node) {
    return new SingleLanguageDependency(node);
  }
  ...
  public static final SingleLanguageDependencyConcept INSTANCE = new SingleLanguageDependencyConcept();
  private SingleLanguageDependencyConcept() {
    super(false, "org.modelix.model.repositoryconcepts.structure.SingleLanguageDependency", "SingleLanguageDependency", "0a7577d1-d4e5-431d-98b1-fae38f9aee80/2206727074858242429");
  }
