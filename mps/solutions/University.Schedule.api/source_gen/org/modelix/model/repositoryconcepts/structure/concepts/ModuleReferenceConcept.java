...
import org.modelix.model.repositoryconcepts.structure.ModuleReference;
...
public class ModuleReferenceConcept extends AbstractConcept<ModuleReference> {

  @NotNull
  @Override
  public ModuleReference createInstance(@NotNull INode node) {
  ...
  public static final ModuleReferenceConcept INSTANCE = new ModuleReferenceConcept();
  private ModuleReferenceConcept() {
    super(false, "org.modelix.model.repositoryconcepts.structure.ModuleReference", "ModuleReference", "0a7577d1-d4e5-431d-98b1-fae38f9aee80/5782622473578468308");
  }

  @Override
  protected void doInit() {
    this.references.put("", new MPSReferenceLink(this, ModuleConcept.INSTANCE, false, "module"));
