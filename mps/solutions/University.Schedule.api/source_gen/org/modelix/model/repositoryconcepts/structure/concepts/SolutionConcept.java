...
import org.modelix.model.repositoryconcepts.structure.Solution;
...
public class SolutionConcept extends AbstractConcept<Solution> {

  @NotNull
  @Override
  public Solution createInstance(@NotNull INode node) {
  ...
  public static final SolutionConcept INSTANCE = new SolutionConcept();
  private SolutionConcept() {
    super(false, "org.modelix.model.repositoryconcepts.structure.Solution", "Solution", "0a7577d1-d4e5-431d-98b1-fae38f9aee80/7341098702109598211");
  }
