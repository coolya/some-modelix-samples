...
| xref:samples:todo.adoc[❔ + websockets] | A web application that allows editing of MPS models and realtime collaboration. | ❌ | `collaboration-web-app`
| xref:samples:todo.adoc[docker / kubernetes]| | ❌ | `deployment`
|===
