...
This 'component' is not a real component but rather a start helper - the xref:modelix:ROOT:main/todo.adoc[`model-server`] is started using the gradle application plugin.
